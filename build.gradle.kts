...
subprojects {
    ...
    cloudstream {
        ...
        setRepo(System.getenv("GITHUB_REPOSITORY") ?: "https://github.com/ardacy2112/ardacrepo")

        authors = listOf("ardac")
    }
    ...
    dependencies {
        ...
        cloudstream("com.github.recloudstream:cloudstream3:3.4.4")
